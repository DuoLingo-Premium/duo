...
export const setProgressPercentage = createAction<number>(
  "game/setProgressPercentage"
);
export const incrementProgressPercentage = createAction<number>(
  "game/incrementProgressPercentage"
);
// Extra Lives actions
